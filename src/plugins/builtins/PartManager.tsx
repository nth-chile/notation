          ...
          >
            ...
            <div className="flex gap-0.5">
              <Button
                ...
                size="sm"
                className={cn("h-5 w-5.5 p-0 text-[9px] font-bold", part.solo && "bg-yellow-500 hover:bg-yellow-600 text-black border-yellow-600")}
              ...
              <Button
                ...
                size="sm"
                className={cn("h-5 w-5.5 p-0 text-[9px] font-bold", part.muted && "bg-red-500 hover:bg-red-600 text-white border-red-600")}
                onClick={(e) => { e.stopPropagation(); toggleMute(index); }}
                title="Mute"
              >M</Button>
              <Button variant="outline" size="sm" className="h-5 w-5.5 p-0 text-[10px]" onClick={(e) => { e.stopPropagation(); reorderPart(index, "up"); }} disabled={index === 0} title="Move Up">&uarr;</Button>
              <Button variant="outline" size="sm" className="h-5 w-5.5 p-0 text-[10px]" onClick={(e) => { e.stopPropagation(); reorderPart(index, "down"); }} disabled={index === score.parts.length - 1} title="Move Down">&darr;</Button>
              <Button variant="outline" size="sm" className="h-5 w-5.5 p-0 text-[12px]" onClick={(e) => { e.stopPropagation(); removePart(index); }} disabled={score.parts.length <= 1} title="Remove Part">&times;</Button>
            </div>
          </div>
        ))}
      </div>
